...
```bash
git clone https://github.com/ericdalaporta/portfolio.git
cd portfolio
```
...
[ericdasilvadalaporta@gmail.com](mailto:ericdasilvadalaporta@gmail.com) · [LinkedIn](https://linkedin.com/in/ericdalaporta) · [GitHub](https://github.com/ericdalaporta)
